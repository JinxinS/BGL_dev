...
public:
	Sample_graph1(){
		...
		add_edge(0,1,edge_properties("out",edge_i_property("i0")),siw_graph);
		add_edge(0,1,edge_properties("out",edge_i_property("i1")),siw_graph);
		add_edge(0,1,edge_properties("out",edge_i_property("i2")),siw_graph);
		add_edge(0,2,edge_properties("out",edge_i_property("i1")),siw_graph);
		add_edge(1,2,edge_properties("out",edge_i_property("i0")),siw_graph);
	}
	~Sample_graph1(){}
};
...
public:
	Sample_graph2(){
		...
		add_edge(1,2,edge_properties("out",edge_i_property("i0")),siw_graph);
		add_edge(1,2,edge_properties("out",edge_i_property("i1")),siw_graph);
		add_edge(1,2,edge_properties("out",edge_i_property("i2")),siw_graph);
		add_edge(1,3,edge_properties("out",edge_i_property("i1")),siw_graph);
		add_edge(2,3,edge_properties("out",edge_i_property("i0")),siw_graph);
		//add_edge(3,2,edge_properties("out",edge_i_property("i1")),siw_graph);
		add_edge(2,4,edge_properties("out",edge_i_property("i0")),siw_graph);
		add_edge(2,5,edge_properties("out",edge_i_property("i1")),siw_graph);
	}
	~Sample_graph2(){}
};

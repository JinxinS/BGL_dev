...
$(test.bin): $(test.unit.bin.dir)/Test% : Test%.o $(helper.objs) $(GMOCK_DIR)/libgmock.a -lsideconf -lboost_unit_test_framework -lboost_log -lboost_system -lboost_filesystem -lboost_thread | $(test.unit.bin.dir)
	$(CXX) -pthread -o $@ $^
